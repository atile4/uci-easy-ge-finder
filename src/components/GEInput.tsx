      ...
      <Box className={styles.container}>
        <FormControl fullWidth>
          ...
          >
            ...
            <MenuItem value={"GE-3"}>III. Social and Behavioral Sciences</MenuItem>
            <MenuItem value={"GE-4"}>IV. Arts and Humanities</MenuItem>
            <MenuItem value={"GE-5A"}>Va. Quantitative, Symbolic, and Computational Reasoning</MenuItem>
            <MenuItem value={"GE-5B"}>Vb. Quantitative, Symbolic, and Computational Reasoning</MenuItem>
            <MenuItem value={"GE-6"}>VI. Language Other Than English</MenuItem>
            <MenuItem value={"GE-7"}>VII. Multicultural Studies</MenuItem>
            <MenuItem value={"GE-8"}>VIII. International/Global Issues</MenuItem>
          </Select>
        </FormControl>
